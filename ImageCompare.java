...
import com.sun.image.codec.jpeg.*;
 ...
 public class ImageCompare {
	...
	public static void main(String[] args) throws IOException {
		...
		String output1 = FaceDetector.getFace("1_10_.gif");
		String output2 = FaceDetector.getFace("1_7_.gif");
	...
	protected void scaleImages(){
		 ...
		 double scaleX = (double)img1w/img2w;
		 double scaleY = (double)img1h/img2h;
		 
		 AffineTransform scaleTransform = AffineTransform.getScaleInstance(scaleX, scaleY);
		 AffineTransformOp bilinearScaleOp = new AffineTransformOp(scaleTransform, AffineTransformOp.TYPE_BILINEAR);
		 
		 img2 = bilinearScaleOp.filter( img2, new BufferedImage(img1w, img1h, img2.getType()));
